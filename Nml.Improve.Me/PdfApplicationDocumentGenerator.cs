...
namespace Nml.Improve.Me
{
	public class PdfApplicationDocumentGenerator : IApplicationDocumentGenerator
	{
		...
		public InReviewApplicationViewModel MapInReviewApplication (Application application, string inReviewMessage)
        {
			var newModel = new InReviewApplicationViewModel
			{
				ReferenceNumber = application.ReferenceNumber,
				State = application.State.ToDescription(),
